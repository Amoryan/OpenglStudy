...
import com.fxyan.opengl.geometry.cone.ConeActivity;
...
import com.fxyan.opengl.geometry.polygon.EdgeInputActivity;
import com.fxyan.opengl.geometry.polygon.PolygonActivity;
...
public final class GeometryMenuActivity
    ...
    protected void genData(List<ActivityMenu> data) {
        ...
        data.add(new ActivityMenu(EdgeInputActivity.class, "多边形"));
        data.add(new ActivityMenu(CircleActivity.class, "圆"));
        data.add(new ActivityMenu(ConeActivity.class, "圆锥"));
